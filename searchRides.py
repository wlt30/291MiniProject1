...
def messageOwner(database, dbcursor, rideindex, displayedrides, member):
    os.system(cls)
    ...
    if fetch.upper() == 'BACK':
        ...
        dbcursor.execute((
            "INSERT INTO inbox VALUES ('{}', datetime('now'), '{}', '{}', {}, 'n')").format(owner, member, fetch, rno))
...
def searchForRide(database, dbcursor, member):
        ...
        while len(ridelist) != 0:
            ...
            if len(ridelist) != 0:
                ...
                if fetch.upper() == 'MORE':
                    os.system(cls)
                    os.system(cls)
                    os.system(cls) #CLEAR ONLY CLEARS WHAT IS VISIBLE. I DO THIS 3 TIMES TO ENSURE ENTIRE WINDOW IS CLEARED
                    continue
                    ...
                    messageOwner(database, dbcursor, int(fetch) - 1, displayedrides, member)
                    break
                    ...
                    os.system(cls) #if the user wants to go back to main menu
                    return
